...
[x] 5. add enemy armies, so we can code attacking/defending

- add castles and forests
...
class BoardState(ComputerAI):
    ...
    def attack(self, enemy):
        ...
        player_attack = ((self.active_army.gen.war/enemy.gen.war) * def_bonus) * army_ratio
        print('calc',(self.active_army.gen.war/enemy.gen.war), def_bonus, army_ratio) 
        enemy_defense = 1/player_attack
        print(player_attack, enemy_defense)
